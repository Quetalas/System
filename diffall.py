...
def intersect(seq1, seq2):
    """
    Возвращает общие для seq1 и seq2 элементы
    :param seq1:
    :param seq2:
    :return:
    """
...
def comparetrees(dir1, dir2, diffs, verbose=False):
    ...
    if not dirdiff.comparedis(dir1, dir2, names1, names2):
        ...
        if os.path.isfile(path1) and os.path.isfile(path2):
            ...
            while True:
                ...
                if bytes1 != bytes2:
                    ...
                    print(name, 'DIFFERS')
                    break
    #рекурсивно сравниваем каталоги с одинаковыми именами
    for name in common:
        path1 = os.path.join(dir1, name)
        path2 = os.path.join(dir2, name)
    ...
    #одинаковые имена но оба не файл и не каталог?
    for name in missed:
